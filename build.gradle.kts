                    ...
                    publications {
                        create<MavenPublication>("maven") {
                            ...
                            pom {
                                ...
                                description.set(
                                    if (isAnalyzer)
                                        "Analyzer for package-private candidates in Kotlin code"
                                ...
                                scm {
                                    url.set("https://github.com/AlexandrosAlexiou/package-private")
                                    connection.set(
                                        "scm:git:git://github.com/AlexandrosAlexiou/package-private.git"
                                    )
                                    developerConnection.set(
                                        "scm:git:ssh://github.com/AlexandrosAlexiou/package-private.git"
                                    )
                                }
                            }
                        }
